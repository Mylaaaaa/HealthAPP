package com.zihanwang.myhealth.presentation.screen.exercisesession.course
...
fun NavGraphBuilder.coursesGraph(nav: NavController) {
    composable(CourseRoutes.HOME) {
        com.zihanwang.myhealth.presentation.screen.exercisesession.ExerciseCoursesScreen(
