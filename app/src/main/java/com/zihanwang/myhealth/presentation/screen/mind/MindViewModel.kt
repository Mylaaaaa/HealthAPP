...
import com.zihanwang.myhealth.presentation.screen.mind.db.MindDatabase
import com.zihanwang.myhealth.presentation.screen.mind.db.MoodLogEntity
import com.zihanwang.myhealth.presentation.screen.mind.db.SessionEntity
import com.zihanwang.myhealth.presentation.screen.mind.db.MoodCountDto
...
class MindRepository(
    private val sessionDao: com.zihanwang.myhealth.presentation.screen.mind.db.SessionDao,
    private val moodDao: com.zihanwang.myhealth.presentation.screen.mind.db.MoodDao
) {
    ...
    fun observeLastMoodOf(date: LocalDate): Flow<com.zihanwang.myhealth.presentation.screen.mind.db.MoodLogEntity?> =
